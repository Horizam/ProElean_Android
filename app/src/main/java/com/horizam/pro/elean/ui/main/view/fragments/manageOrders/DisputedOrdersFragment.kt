...
import com.horizam.pro.elean.ui.main.adapter.DisputedOrdersAdapter
...
class DisputedOrdersFragment : Fragment(), OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {

    private lateinit var binding: FragmentOrdersGenericBinding
    private lateinit var adapter: DisputedOrdersAdapter
    ...
    private fun initViews() {
        adapter = DisputedOrdersAdapter(this)
...
//        })
    ...
    private fun setAdapterLoadState(adapter:DisputedOrdersAdapter) {
    ...
    override fun <T> onItemClick(item: T) {
        if (item is Order) {
            Intent(requireContext(), OrderDetailsActivity::class.java).also {
                ...
                it.putExtra(Constants.ORDER_USER_ACTION, BuyerOrders.Disputed)
