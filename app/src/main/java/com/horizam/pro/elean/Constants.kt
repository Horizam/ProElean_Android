...
class Constants {
    ...
    companion object {
        ...
        const val DELIVER="Order_Delivered"
        const val CREATE_DISPUTE="Cancel_And_Create_Dispute "
        const val REJECT_DISPUTE="Order_Dispute_Rejected"
        const val ACCEPT_DISPUTE="Order_Dispute_Accepted"
        const val EXTEND_REQUEST="Extend_Time_Request"
        const val REJECTED_TIME="Rejected_Time_Extension"
        const val ACCEPTED_TIME="Accepted_Time_Extension"
