...
import com.horizam.pro.elean.ui.main.adapter.RevisionOrdersAdapter
...
class RevisionOrdersFragment : Fragment(), OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {

    private lateinit var binding: FragmentOrdersGenericBinding
    private lateinit var adapter: RevisionOrdersAdapter
    ...
    private fun initViews() {
        adapter = RevisionOrdersAdapter(this)
...
//        })
    ...
    private fun setAdapterLoadState(adapter: RevisionOrdersAdapter) {
    ...
    override fun <T> onItemClick(item: T) {
        if (item is Order) {
            Intent(requireContext(), OrderDetailsActivity::class.java).also {
                ...
                it.putExtra(Constants.ORDER_USER_ACTION, BuyerOrders.Revision)
