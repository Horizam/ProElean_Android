...
class LateOrdersFragment : Fragment(), OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {

    private lateinit var binding: FragmentOrdersGenericBinding
    private lateinit var adapter: LateOrdersAdapter
    ...
    private fun initViews() {
        adapter = LateOrdersAdapter(this)
...
//        })
    ...
    private fun setAdapterLoadState(adapter: LateOrdersAdapter) {
    ...
    override fun <T> onItemClick(item: T) {
        if (item is Order) {
            Intent(requireContext(), OrderDetailsActivity::class.java).also {
                ...
                it.putExtra(Constants.ORDER_USER_ACTION, BuyerOrders.Late)
