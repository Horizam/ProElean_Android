...
class CancelOrdersFragment : Fragment() , OnItemClickListener, SwipeRefreshLayout.OnRefreshListener  {

    private lateinit var binding: FragmentOrdersGenericBinding
    private lateinit var adapter: CancelOrdersAdapter
    ...
    private fun initViews() {
        adapter = CancelOrdersAdapter(this)
...
//        })
    ...
    private fun setAdapterLoadState(adapter: CancelOrdersAdapter) {
    ...
    override fun <T> onItemClick(item: T) {
        if (item is Order) {
            Intent(requireContext(), OrderDetailsActivity::class.java).also {
                ...
                it.putExtra(Constants.ORDER_USER_ACTION, BuyerOrders.Cancel)
