...
class ApiHelper(private val apiService: ApiService) {
    ...
    suspend fun getSpinnerSubcategories(id: Int) = apiService.getSpinnerSubcategories(id)
    ...
    suspend fun deleteUserService(id: Int) = apiService.deleteUserService(id)
    ...
    suspend fun getSubcategories(id: Int, position: Int,query: String) = apiService.getSubcategories(id,position,query)
    suspend fun getSellers(id: Int, position: Int) = apiService.getSellers(id,position)
